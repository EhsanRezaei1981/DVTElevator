...
namespace DVTElevator.xUnitTest
{
    public class ElevatorUnitTest
    {
        ...
        public void AddPersonForFloor2_4_6_8_ThenReturnShouldBeFalse(int floor)
        {
            ...
            //Act
            var resultAddPerson = elevator.AddPerson(new DTVElevator.Dto.Model.Person
            {
                Weight = 70,
                FloorToGo = floor
            });
        ...
        public void AddPersonForFloor1WithWeightMoreThanStandard_ThenReturnShouldBeFalse()
        {
            ...
            //Act
            resultAddPerson = elevator.AddPerson(new DTVElevator.Dto.Model.Person
            {
                Weight = 70,
                FloorToGo = 5
            });
        ...
        public void Move_FromFloor1ToFloor7_ShouldReturnFloor7AndDirectionDown()
        {
            ...
            var resultMove = elevator.Move();
            //Assert
            Assert.True(elevator.CurrentFloor == floorToGo && elevator.Direction == DTVElevator.Dto.Enums.ElevatorDirection.Down);
        }
        ...
        public void Move_FromFloor7ToFloor1_ShouldReturnFloor1AndDirectionUp()
        {
            ...
            var floorToGo = 1;
            var repo = new ElevatorRepository();
            repo.AddElevator(new DTVElevator.Service.Elevator.ElevatorService("EL1", new List<int> { { 1 }, { 3 }, { 5 }, { 7 } }, 200, 7));
            ...
            var resultMove = elevator.Move();
            //Assert
            Assert.True(elevator.CurrentFloor == floorToGo && elevator.Direction == DTVElevator.Dto.Enums.ElevatorDirection.Up);
        }
